       ...
       <div class="col-md-4">
         <div class="form-group">
             ...
             <select class="form-control" id="critere" name="Appeloffre">
               <option value="<?php echo OFATTENTE;  ?>">Offre en entente</option>
               <option value="<?php echo OFFRECHOISIE;  ?>">Offre choisie</option>
               <option value="<?php echo OFPAYEE;  ?>">Offre Payée</option>
               <option value="<?php echo OFCOURSTRAITEMENT;  ?>">Offre en cours traitement</option>
               <option value="<?php echo OFTERMINERENCONTENCIEUX;  ?>">Offre terminer en entente contentieux</option>
               <option value="<?php echo OFPAYERPARADMIN;  ?>">Offre payée par l'administrateur en entente de validation</option>
               <option value="<?php echo OFTERMINER;  ?>">Offre terminée</option>
             </select>
           </div>
       </div>
       <div class="col-md-4"></div>
