...
<div class="table-responsive">
    <table class="table table-hover tablesorter pdf_border">
        ...
        <a class="pull-right btn btn-warning btn-large" style="margin-right:40px" href="<?php echo site_url()?>Client/save_pdf"><i class="fa fa-file-excel-o"></i> PDF Data</a>
        <tbody>
            <?php
            if (isset($mobiledata) && !empty($mobiledata)) {
                foreach ($mobiledata as $key => $val) {
                    ...
                    <tr class="pdf_border">
                        ...
                        <td class="pdf_border"><?php echo $val['company']; ?></td>
                        <td class="pdf_border"><?php echo $val['mobile_category']; ?></td>
                    </tr>
                    <?php
                }
            } else {
