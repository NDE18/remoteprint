          ...
          <table id="example1" class="table table-bordered table-striped" style="font-family:cambria">
            ...
            <?php
                  // var_dump($secretariats);
                              ...
                              <!--  <a href="#" onclick="document.getElementById('<?php  echo $liste->id;?>')"class="lock w3-btn w3-white w3-small w3-margin-small" title="plus de détail">
                                ...
                                switch ($liste->statut)
                                {
                                    case '0':
                                        ...
                                        break;
                                    case '1':
                                        echo '<a title="Suspendre" class = " susp_'.$liste->id.'" id="'.$liste->id.'"><button class="btn suspendre btn-danger btn-xs" id="suspendre"><i class="fa fa-trash-o "></i>suspendre</button></a>';
                    ...
                    {
                        echo '<tr><td colspan="6"  class="h3 text-center"><a href="#" class="text-warning">Aucune demande Valider pour le moment ...</a><td></tr>';
                    }
                    ?>
