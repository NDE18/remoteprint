    ...
    <div class="top-brands">
        <div class="container">
            <h3 style="margin-top: -40px">Découvrez nos services</h3>
            <div id="Products" >
                    ...
                    <div class="row c productgrid">
                        <?php  foreach($services as $service){
                            ...
                            <div class='col-md-3'>
                                ...
                                <div class="img">
                                    <a href="<?php echo base_url('home/service/'.$service->id)?>"><img alt="<?php echo ucfirst($service->nom);?>" src="<?php echo base_url('assets/uploads/images/service/'.$service->image)?>" /><?php echo ucfirst(strtolower($service->nom));?></a>
                                </div>

                                <div class="fade">

                                    <div class="productlink">
                                        <a href="<?php echo base_url('home/service/'.$service->id)?>"><?php echo ucfirst($service->nom);?></a>
                                    </div>

                                </div>

                                <div class="hidden" id="ProductBox1_tt">
                                    <div class="start_tt">
