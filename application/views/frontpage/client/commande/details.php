...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <b><h2 class="modal-title text-success">Détails de la commande Cmd<?php echo $apercu->num ?></h2></b>
        </div>
                ...
                <div class="row table-responsive">
                    ...
                    <div class="col-md-5">
                        <div class="box box-default">
                            ...
                            <div class="box-body">
                                <label class="">Total HT + frais Om: </label> <span class="pull-right"><?php  echo isset($carac_offre['remise'])? number_format($apercu->prixTotal+$carac_offre['remise']-$carac_offre['total_om'], 2, '.', '') : number_format($apercu->prixTotal, 2, '.', '')?></span>
